...
CREATE TABLE CUENTA_CORRIENTE (
    ...
    CONSTRAINT CK_CC_ESTADO         CHECK (ESTADO IN ('PENDIENTE', 'PARCIAL', 'PAGADO')),
...
-- procesa todos de una vez sin riesgo de ORA-04091.
    ...
    BEGIN
        FOR i IN 1 .. v_volantes.COUNT LOOP
            ...
            UPDATE CUENTA_CORRIENTE SET ESTADO = v_nuevo_estado
...
GROUP BY e.ID_ESTUDIANTE, e.CARNET, e.NOMBRE, e.APELLIDO, pa.NOMBRE_PROGRAMA, per.NOMBRE_PERIODO, cc.ESTADO;
...
VALUES (SEQ_MOVIMIENTO.NEXTVAL,SYSDATE,8500000,'PMAT',1,1,1);

INSERT INTO MOVIMIENTO (ID_MOV,FECHA,VALOR,CODIGO_DETALLE,ID_CUENTA,ID_VOLANTE,ID_PERIODO)
VALUES (SEQ_MOVIMIENTO.NEXTVAL,SYSDATE,4000000,'MPAG',1,1,1);

INSERT INTO TRANSACCION_PAGO (ID_TRANSACCION,REFERENCIA,MEDIO_PAGO,FECHA_PAGO,ID_MOV)
VALUES (SEQ_TRANSACCION.NEXTVAL,'REF-2026-001','EFECTIVO',SYSDATE,2);
